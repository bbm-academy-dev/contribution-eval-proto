(function () {
  ...
  // Спринт #2 — расширенный скоуп: платформы, публичный сайт, контент, GTM, отдельные треки.
  // Гранулярность зафиксирована владельцем модели: «Платформа BBM» — одной строкой (7 подсистем в описании);
  // Платформа DS вместе с приложением врача; финансирование и найм — самостоятельные продукты; BBM Energy — отдельный продукт.
  const PRODUCTS = [
    {
      key: "platform_ds",
      title: "Платформа Doctor.School",
      short: "Платформа DS",
      description: "Экосистема Doctor.School: backend, фронты, роли; включая мобильное приложение врача (первый фронт)."
    },
    {
      key: "platform_bbm",
      title: "Платформа BBM",
      short: "Платформа BBM",
      description: "Внутренняя инфра-платформа холдинга: коммуникации (Mattermost), база знаний, управление задачами (Plane), корпоративный ИИ-агент, мониторинг/алертинг, инфраструктура."
    },
    {
      key: "site_bbm",
      title: "Сайт BBM",
      short: "Сайт BBM",
      description: "Публичный сайт BBM (content-backend Payload)."
    },
    {
      key: "content_factory",
      title: "Контент-завод",
      short: "Контент-завод",
      description: "Интерактивные мульт-кейсы, уроки в приложении, тесты; сценарная система + AI-конвейер."
    },
    {
      key: "promotion",
      title: "Продвижение проекта",
      short: "Продвижение",
      description: "Соцсети, контент на сайте, подкасты с командой и экспертами мед-сообщества, промо-ролики."
    },
    {
      key: "webinars",
      title: "Вебинары",
      short: "Вебинары",
      description: "Подготовка и проведение вебинаров."
    },
    {
      key: "fundraising",
      title: "Привлечение инвесторов и партнёров",
      short: "Инвесторы",
      description: "Переговоры с инвесторами и партнёрами, финансирование."
    },
    {
      key: "hiring",
      title: "Найм команды и экспертов",
      short: "Найм",
      description: "Найм команды, привлечение экспертов и «адвокатов» проекта."
    },
    {
      key: "energy",
      title: "Доступная энергия (BBM Energy)",
      short: "Энергия",
      description: "Рыночная аналитика доступной энергии (ГПУ) — отдельный трек."
    }
  ];

  const PREFIX = "SPRINT-EVAL::";
  ...
  function decodeBlock(text) {
    ...
    if (!trimmed.startsWith(PREFIX)) throw new Error("Нет префикса SPRINT-EVAL");
